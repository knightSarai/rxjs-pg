import { fromEvent, merge, NEVER, concat, race, forkJoin } from 'rxjs';
import {
  mapTo,
  startWith,
  switchMap,
...
export const mergeMethodSelect = document.getElementById('merge-method');
...
export const mergeMethods = {concat, merge, race, forkJoin}
